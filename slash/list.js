...
module.exports = {
  ...
  const msg = await interaction.channel.send({ embeds: [new Discord.MessageEmbed().setDescription("Choose an option in the select menu to get started!").setColor("#00FFFF").setTimestamp()], components: [row] })
